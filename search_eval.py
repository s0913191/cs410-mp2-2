...
def load_ranker(cfg_file):
    ...
    #PASSED!! 0.4291865018197321
    #return metapy.index.OkapiBM25(k1=1.9,b=0.65,k3=6.5)

    #PASSED!! 0.43082289032771875
    #return metapy.index.OkapiBM25(k1=1.9,b=0.6,k3=6.5)

    #PASSED!! 0.43135248413253957
    #return metapy.index.OkapiBM25(k1=2.1,b=0.6,k3=1)

    #PASSED!! 0.430268436000514
    #return metapy.index.OkapiBM25(k1=2,b=0.65,k3=1)

    return metapy.index.OkapiBM25(k1=2,b=0.6,k3=0.8)

    #SOTA 0.43149164204531615
    #return metapy.index.OkapiBM25(k1=2,b=0.6,k3=1)

    #PASSED!! 0.43130184126053506
    #return metapy.index.OkapiBM25(k1=1.9,b=0.6,k3=1)

    #Fail
    #return metapy.index.OkapiBM25(k1=1.25,b=0.79,k3=1)
    
    #PASSED!! 0.43080763818161616
    #return metapy.index.OkapiBM25(k1=2,b=0.6,k3=6.5)

    #PASSED!! 0.42709887035416555
    #return metapy.index.OkapiBM25(k1=1.9,b=0.7,k3=6.5)

    #PASSED!! 0.43080229542553183
    #return metapy.index.OkapiBM25(k1=2,b=0.6,k3=7)

    #PASSED!! 0.43072895355961865
    #return metapy.index.OkapiBM25(k1=2,b=0.6,k3=6)

    #PASSED!! 0.43044677201792897
